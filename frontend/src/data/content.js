// ─────────────────────────────────────────────────────────────
// content.js  –  Edit all portfolio data here
// ─────────────────────────────────────────────────────────────
...
// ── Photography ───────────────────────────────────────────────
export const photos = [
  { src: 'https://picsum.photos/seed/ph1/800/600',  title: 'Golden Hour, Iceland',        desc: 'Shot on a mirrorless during the midnight sun. Long exposure, no filters.' },
  { src: 'https://picsum.photos/seed/ph2/600/900',  title: 'Portrait Study #4',            desc: 'Available light, north-facing window. Kodak Portra 400 emulation.' },
  { src: 'https://picsum.photos/seed/ph3/800/500',  title: 'Hamburg Harbour, Dawn',        desc: 'Pre-dawn fog rolling off the Elbe. 5am alarm well worth it.' },
  { src: 'https://picsum.photos/seed/ph4/700/700',  title: 'Geometry & Shadow',            desc: 'Brutalist stairwell, abandoned department store, natural light only.' },
  { src: 'https://picsum.photos/seed/ph5/900/600',  title: 'Open Water',                   desc: 'Baltic Sea in November. 1/2000s to freeze the wave crests.' },
  { src: 'https://picsum.photos/seed/ph6/600/800',  title: 'Street — Tokyo, 2023',         desc: 'Shinjuku at 2am. Ricoh GR IIIx, zone focus, single burst.' },
  { src: 'https://picsum.photos/seed/ph7/800/600',  title: 'Forest Interior',              desc: 'Old-growth beech forest, October. Mist reduces contrast beautifully.' },
  { src: 'https://picsum.photos/seed/ph8/1000/600', title: 'Panorama — Lofoten',           desc: 'Stitched from 7 vertical frames. 100MP equivalent output.' },
  { src: 'https://picsum.photos/seed/ph9/600/900',  title: 'Still Life — Ceramics',        desc: 'Product photography for a local pottery studio.' },
  { src: 'https://picsum.photos/seed/ph10/800/600', title: 'Commute',                      desc: 'U-Bahn window reflection. 1/60s, f/2, accepted the motion blur.' },
  { src: 'https://picsum.photos/seed/ph11/700/500', title: 'The Red Boat',                 desc: 'Alster lake, midday. Colour was the whole point.' },
  { src: 'https://picsum.photos/seed/ph12/800/800', title: 'Square Study — Architecture',  desc: 'Symmetry hunting in the HafenCity district.' },
];
...
export const about = {
  ...
  skillGroups: [
    {
      label: 'Skills',
      items: ['UX/UI', 'Graphic Design', 'Web Design', 'Photography', 'Video Editing', 'Audio Editing'],
    },
    {
      label: 'Tools',
      items: ['JavaScript', 'Python', 'Html & CSS', 'SQL', 'Linux', 'Windows', 'MacOS', 'Photography', 'Illustrator', 'InDesign', 'Lightroom', 'Cinema 4D'],
    },
    {
      label: 'Languages',
...
export const impressum = [
  ...
  {
    heading: 'Kontakt',
    text: 'E-Mail: hello@johndoe.dev\nTelefon: +49 12 123456789',
  },
  {
    heading: 'Haftungsausschluss',
    text: 'Die Inhalte dieser Seiten wurden mit größter Sorgfalt erstellt. Für die Richtigkeit, Vollständigkeit und Aktualität der Inhalte kann jedoch keine Gewähr übernommen werden.',
  },
  {
